...
class MFCCExtractor:
    ...
    def slice_audio(self, file_path: str, discard_last_chunk: bool):
        """
        ...
        :param discard_last_chunk: If True, the audio file was prerecorded, and we cannot be sure of
        its length, so we discard the last chunk generated. If False, then the audio file came from
        a microphone recording generated by this program and its length is a multiple of AUDIO_CHUNK_LEN.
        :return: None
        """
        ...
        for i, chunk in enumerate(audio_chunks[:-1] if discard_last_chunk else audio_chunks):
